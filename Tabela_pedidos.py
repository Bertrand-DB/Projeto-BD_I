...
class Tabela_pedidos():
    ...
    def label_entry(self):
        ...
        self.col0_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*1 + ALTURA_LABEL*0 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col1_Label = Label(self.quadro_1,text=self.NOME_COLUNA[1],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col1_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*2 + ALTURA_LABEL*1 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col2_Label = Label(self.quadro_1,text=self.NOME_COLUNA[2],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col2_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*3 + ALTURA_LABEL*2 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col3_Label = Label(self.quadro_1,text=self.NOME_COLUNA[3],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col3_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*4 + ALTURA_LABEL*3 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col4_Label = Label(self.quadro_1,text=self.NOME_COLUNA[4],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col4_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*5 + ALTURA_LABEL*4 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col5_Label = Label(self.quadro_1,text=self.NOME_COLUNA[5],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col5_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*6 + ALTURA_LABEL*5 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)

        self.col6_Label = Label(self.quadro_1,text=self.NOME_COLUNA[6],font=('Arial',12),bg="#feffff", fg="#403d3d")
        self.col6_Label.place(relx=X_LABEL, rely=ESPACAMENTO_LB*7 + ALTURA_LABEL*6 -0.06, relwidth=LARGURA_LABEL, relheight=ALTURA_LABEL)
        ...
        self.col0_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*1 + ALTURA_LABEL*0-0.06, relwidth=0.5, relheight=ALTURA_LABEL)

        self.col1_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col1_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*2 + ALTURA_LABEL*1-0.06, relwidth=0.5, relheight=ALTURA_LABEL)

        self.col2_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col2_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*3 + ALTURA_LABEL*2-0.06, relwidth=0.5, relheight=ALTURA_LABEL)

        self.col3_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col3_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*4 + ALTURA_LABEL*3-0.06, relwidth=0.3, relheight=ALTURA_LABEL)

        self.col4_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col4_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*5 + ALTURA_LABEL*4-0.06, relwidth=0.3, relheight=ALTURA_LABEL)

        self.col5_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col5_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*6 + ALTURA_LABEL*5-0.06, relwidth=0.6, relheight=ALTURA_LABEL)

        self.col6_entry = Entry(self.quadro_1, width=25, justify='left', font=("Arial", 12), highlightthickness=1, relief="solid")
        self.col6_entry.place(relx=X_LABEL+LARGURA_LABEL, rely=ESPACAMENTO_LB*7 + ALTURA_LABEL*6-0.06, relwidth=0.4, relheight=ALTURA_LABEL)
    ...
    def preencher(self, event):
        ...
        for n in self.lista.selection():
            ...
            self.col4_entry.insert(END, col5)
            self.col5_entry.insert(END, col6)
            self.col6_entry.insert(END, col7)
    ...
    def insert_bt(self):
        ...
        if not self.fsql.insert_pedidos(entrys): return
        self.atualiza_tabela()
        self.clear_entry()
    ...
    def update_bt(self):
        ...
        entrys = self.get_entry()
        if not self.fsql.update_pedidos(entrys): return
        self.atualiza_tabela()
        self.clear_entry()
    
    def delete_bt(self):
        entrys = self.get_entry()
        if not self.fsql.delete_pedidos(entrys): return
        self.atualiza_tabela()
        self.clear_entry()
    ...
    def select_bt(self):
        ...
        encontrado = self.fsql.select_pedidos(entrys)
